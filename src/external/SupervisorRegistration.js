    ...
    return (
        <>
            ...
            <Modal show={show} onHide={handleClose} dialogClassName="modal-100w">
                ...
                <Modal.Body>
                    <h2 className="Heading mb-3 mt-3">Personal Data</h2>
                    <Container className="border rounded border-success p-5">
                    ...
                    <h2 className="Heading mb-3 mt-3">Office Data</h2>
                    <Container className="border rounded border-success p-5">
                        <Form>
                            <Row className="mb-3">
                                <Col>
                ...
                <Modal.Footer>
                    ...
                    <Button className="mb-3 ms-4 center" variant="warning" type="Exit" onClick={handleClose}>
                        Back
                    </Button>
                </Modal.Footer>
            </Modal>
